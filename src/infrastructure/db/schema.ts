...
export const payments = pgTable("payments", {
  ...
  provider: text("provider", { enum: ["manual", "stripe"] }).notNull(),
  status: text("status", {
...
export const memberships = pgTable("memberships", {
  ...
  // Null while status = "invited" — claimed (set) once the invitee creates
  // an account with a matching email.
...
export const announcements = pgTable("announcements", {
  ...
  status: text("status", { enum: ["draft", "scheduled", "sent", "failed"] }).notNull().default("draft"),
